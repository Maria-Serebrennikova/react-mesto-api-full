// Визуально формы регистрации и входа у меня отображаются как в макете. 
// Пробовала открывать через разные браузеры, разницы нет: черный экран, белая кнопка, все как в макете.
// Списываю на случайность отображения, оставляю верстку и стилистику без изменений.
